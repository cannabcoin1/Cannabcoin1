...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 27243
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 27244
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 37243
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 37244
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 27243
	%{_sbindir}/semanage port -d -p tcp 27244
	%{_sbindir}/semanage port -d -p tcp 37243
	%{_sbindir}/semanage port -d -p tcp 37244
