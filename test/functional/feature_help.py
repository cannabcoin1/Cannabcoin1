...
"""Verify that starting cannabcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cannabcoin with -h for help text")
        ...
        self.log.info("Start cannabcoin with -version for version information")
