...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cannabcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cannabcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cannabcoin transaction") + "\n" +
              "  cannabcoin-tx [options] -create [commands]   " + _("Create hex-encoded cannabcoin transaction") + "\n" +
              "\n";
